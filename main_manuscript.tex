...
\end{equation}
\begin{equation}
    IR_t = \frac{Count_{maj, t}}{\max(1, Count_{min, t})}
\end{equation}
...
\For{each incoming transaction $(x_t, y_t) \in S$}{
    ...
    $IR_t \gets Count_{maj} / \max(1e^{-5}, Count_{min})$\;

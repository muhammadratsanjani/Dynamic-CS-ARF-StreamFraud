...
\begin{itemize}
    ...
    \item We introduce an Implicit Online Oversampling mechanism with a continuous mathematical formulation that dynamically modulates the Poisson bagging distribution $\lambda_t$ in response to real-time fluctuations in the imbalance ratio and drift detection signals.
...
This section details the proposed Dynamic Cost-Sensitive Adaptive Random Forest (Dynamic CS-ARF) architecture. We first describe the foundational mechanism of the standard Adaptive Random Forest and its concept drift detector. Subsequently, we formulate the mathematical basis of our proposed Implicit Online Oversampling technique to handle high class imbalance in a single-pass environment.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1.5]
        ...
        \draw[ultra thick, black] (2.600, -1.95) -- (4.275, -1.95);
        \draw[ultra thick, black] (2.600, -2.0) -- (3.800, -2.0);
        \draw[ultra thick, black] (2.600, -2.05) -- (3.200, -2.05);
        \draw[ultra thick, gray] (3.200, -2.1) -- (4.900, -2.1);
        \draw[ultra thick, gray] (3.200, -2.15) -- (4.675, -2.15);
        \draw[ultra thick, gray] (3.200, -2.2) -- (4.550, -2.2);
        \draw[ultra thick, gray] (3.200, -2.25) -- (4.275, -2.25);
        \draw[ultra thick, gray] (3.200, -2.3) -- (3.800, -2.3);
        \draw[ultra thick, lightgray] (3.800, -2.35) -- (4.900, -2.35);
        \draw[ultra thick, lightgray] (4.275, -2.4) -- (4.900, -2.4);
        \draw[ultra thick, lightgray] (4.550, -2.45) -- (4.900, -2.45);
        \draw[ultra thick, lightgray] (4.675, -2.5) -- (4.900, -2.5);
    \end{tikzpicture}
    \caption{Critical Difference (CD) diagram for the post-hoc Nemenyi test. Classifiers connected by the same horizontal line have no significant performance difference at $\alpha=0.05$.}
...
While this dynamic oversampling delivers a decisive advantage in minority-class detection, it introduces a higher computational overhead compared to unmodified algorithms. Building on the demonstrated statistical significance ($p=0.007$, $\alpha=0.01$), future work will explore hardware-parallelized variations of Dynamic CS-ARF for ultra-low latency trading environments.
